...
| ----------------- | ---------------------- | --------------- | ----------- | ----------------------------------|
| Timeless (ISO/IEC 25012)| DQRP1 | A specific data age is required for the data in an attribute of an entity | [DQRP1](https://github.com/feed-upc/DS-DataQualityRequirements/blob/main/media/DQRP1-Timeless.png)| A hypothetical financial data space instantiates the DQRP1 [DQRP1Instantiation](https://github.com/feed-upc/DS-DataQualityRequirements/blob/main/media/DQRP1Instantiation.png) to define a DQR for specifying that live stock prices are valid only if their data age does not exceed 30 minutes. Its corresponding ODRL rule is [DQRP1ODRLRule](https://github.com/feed-upc/DS-DataQualityRequirements/blob/main/media/DQRP1ODRLRule.png)|
